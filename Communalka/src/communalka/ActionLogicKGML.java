...
//			parent.textFieldSumRez.setText(summa(kvartiraGazMusLift(2, "Квартира"), kvartiraGazMusLift(2, "Газ"), kvartiraGazMusLift(2, "Мусор"), kvartiraGazMusLift(2, "Лифт")));
			parent.sumRezCalc();
			return;
		}
...
//			parent.textFieldSumRez.setText(summa(kvartiraGazMusLift(3, "Квартира"), kvartiraGazMusLift(3, "Газ"), kvartiraGazMusLift(3, "Мусор"), kvartiraGazMusLift(3, "Лифт")));
			parent.sumRezCalc();
			return;
		}
		else {
...
//			parent.textFieldSumRez.setText(summa(kvartiraGazMusLift(1, "Квартира"), kvartiraGazMusLift(1, "Газ"), kvartiraGazMusLift(1, "Мусор"), kvartiraGazMusLift(1, "Лифт")));
			parent.sumRezCalc();
		}
