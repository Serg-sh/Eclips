	...
	public void actionPerformed(ActionEvent e) {
		try {
			if (parent.textFieldElNewPok.hasFocus()) {
				tarifEl_100 = Double.parseDouble(parent.tarif("Ёлектричество до 100 к¬т"));
				tarifEl_101 = Double.parseDouble(parent.tarif("Ёлектричество более 100 к¬т"));
			...
			JOptionPane.showConfirmDialog(null, err.error,"Ќеверный ввод данных", JOptionPane.PLAIN_MESSAGE);
		} catch (NumberFormatException err) {
			JOptionPane.showConfirmDialog(null,"¬ пол€ показани€ необходимо вводить число",	"Ќеверный ввод данных", JOptionPane.PLAIN_MESSAGE);
		}
