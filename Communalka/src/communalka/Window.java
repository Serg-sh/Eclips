...
public class Window {
	...
	String[] month = new String[] {"январь", "‘евраль", "ћарт", "јпрель", "ћай", "»юнь", "»юль", "јвгуст", "—ент€брь", "ќкт€брь", "Ќо€брь", "ƒекабрь"};
	String[] tarifi = new String[] {"Ёлектричество до 100 к¬т","Ёлектричество более 100 к¬т","¬ода","√аз"," вартира 1 кв.м","ћусор","Ћифт","ѕлощадь квартиры (м.кв)"};
	...
	Window() {
		...
		textFieldElNewPok.setToolTipText("¬вести значение и нажать \"Ёнтер\"");
		...
		chckbx_1.setToolTipText("ƒобавить 1 мес€ц");
		wPanel.add(chckbx_1);
		...
		chckbx_2.setToolTipText("ƒобавить 1 мес€ц");
		wPanel.add(chckbx_2);
		...
		comboBox_4.setToolTipText("ƒл€ изменени€ тарифа, необходимо ввести новое значение и нажать \"»зменить\"");
		...
		textFieldWaterNewPok.setToolTipText("¬вести значение и нажать \"Ёнтер\"");
		...
		textFieldRoomSum.setText(stringToBigToString(" вартира 1 кв.м"));
		...
		textFieldGazSum.setText(stringToBigToString("√аз"));
		...
		textFieldMusorSum.setText(stringToBigToString("ћусор"));
		...
		textFieldLiftSum.setText(stringToBigToString("Ћифт"));
...
//		textFieldOtoplMonth_1.setText((String) comboBox_1.getSelectedItem());
		...
		textFieldOtoplTarif_1.setToolTipText("¬вести значение и нажать \"Ёнтер\"");
		...
		textFieldOtoplTarif_2.setToolTipText("¬вести значение и нажать \"Ёнтер\"");
		...
		textFieldOtoplTarif_3.setToolTipText("¬вести значение и нажать \"Ёнтер\"");
		...
		textFieldDolg.setToolTipText("¬вести значение и нажать \"Ёнтер\"");
...
//	String summa(){
//		try {
//		sumDoubl = Double.parseDouble(tarif(" вартира 1 кв.м"));
//		sumDoubl += Double.parseDouble(tarif("√аз"));
//		sumDoubl += Double.parseDouble(tarif("ћусор"));
//		sumDoubl += Double.parseDouble(tarif("Ћифт"));
...
//		}
	...
	String tarif(String val){
		...
		return "no val";
			...
			return "‘айла не найден";
			}
		}

	String stringToBigToString(String str) {
		try {
			if (str.equals(" вартира 1 кв.м")){
				double tmp = Double.parseDouble(tarif(str)) * Double.parseDouble(tarif("ѕлощадь квартиры (м.кв)"));
